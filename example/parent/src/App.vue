<template>
  <div class="col">
    ...
    <iframe src="http://localhost:8001#1" ref="iframe1" sandbox="allow-scripts allow-same-origin" />
  ...
  <div class="col">
    ...
    <iframe src="http://localhost:8001#2" ref="iframe2" sandbox="allow-scripts allow-same-origin" />
